...
const Contact = () => {
  return (
    <div className='relative overflow-hidden'>
      ...
      <div className='absolute py-10 bottom-0 md:top-1/2 md:-translate-y-1/2  md:left-[100px] text-black bg-black bg-opacity-10 rounded-2xl   md:max-w-[753px] px-10'>
        <div>
          ...
          <p className='mt-2 md:text-lg text-center md:text-start'>
            SABA Sports continuously upgrades its core and relevant services. Operators can directly benefit from these
            improved functions without paying extra fees.
          </p>
        </div>
