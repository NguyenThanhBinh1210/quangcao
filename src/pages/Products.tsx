      ...
      <div className={`w-full  md:min-h-0 relative`}>
        ...
        <div className='md:py-[240px] text-white px-10 absolute top-0 md:right-0'>
          <div className='max-w-[590px] ml-auto pt-20 md:pt-0'>
            ...
            <p className='mb-3 text-sm md:text-lg text-center md:text-start'>
              SABA Galaxy View merges youthful visuals with future technology style. It prioritizes user experience with
              an uncluttered interface primarily focused on sporting events. It supports multiple platform screens,
              allowing users to freely switch between card-style or list-style layouts. With one-click quick betting,
              the ability to place various betting options simultaneously on single matches or parlays in one order, and
              the My Favorites function, users can enjoy a new, silky-smooth betting experience.
            </p>
            <button
              style={{ backgroundImage: 'linear-gradient(#c7c7c7, #c7c7c7)' }}
              className=' rounded-full text-lg px-8 py-2 text-orange-600 border border-[#c7c7c7]'
      ...
      <div className='md:py-[100px] text-black px-10 mb-20'>
        <div className='max-w-[640px] mx-auto pt-7 md:pt-0 '>
          ...
          <p className='mb-3 text-sm md:text-lg text-center '>
            ...
            the exact number of corner kicks in the first and second halves, the exact number of goals in penalty kicks,
            penalty kick odd/even, video assistant referee and more.
          </p>
        </div>
      </div>
